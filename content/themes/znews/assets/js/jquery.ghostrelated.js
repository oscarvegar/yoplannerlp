    ...
    RelatedPosts.prototype.displayRelated = function(posts) {
        ...
        related.forEach(function(post) {
            if (count < self.options.limit) {
                $(self.element).append($('<div class="col-md-4 col-related"><a class="rel-link" href="' + post.url + '" style="background-image: url('+post.image+') ;"><div class="related-shadow">' + post.title + '</div></a></div>'));
            }
            count++;
        });
